...
class Koopa(Entity):
    def __init__(self, x_pos, y_pos, move_direction):
        ...
        self.image_tick = 0
        self.images = [
            pg.image.load('mario/Next/images/koopa_0.png').convert_alpha(),
            pg.image.load('mario/Next/images/koopa_1.png').convert_alpha(),
            pg.image.load('mario/Next/images/koopa_dead.png').convert_alpha()
        ]
