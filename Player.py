...
class Player(object):
    def __init__(self, x_pos, y_pos):
        ...
        self.image = pg.image.load('mario/Next/images/mario/mario.png').convert_alpha()
        self.sprites = []
        self.load_sprites()
    ...
    def load_sprites(self):
        self.sprites = [
            # 0 Small, stay
            pg.image.load('mario/Next/images/Mario/mario.png'),

            # 1 Small, move 0
            pg.image.load('mario/Next/images/Mario/mario_move0.png'),

            # 2 Small, move 1
            pg.image.load('mario/Next/images/Mario/mario_move1.png'),

            # 3 Small, move 2
            pg.image.load('mario/Next/images/Mario/mario_move2.png'),

            # 4 Small, jump
            pg.image.load('mario/Next/images/Mario/mario_jump.png'),

            # 5 Small, end 0
            pg.image.load('mario/Next/images/Mario/mario_end.png'),

            # 6 Small, end 1
            pg.image.load('mario/Next/images/Mario/mario_end1.png'),

            # 7 Small, stop
            pg.image.load('mario/Next/images/Mario/mario_st.png'),

            # =============================================

            # 8 Big, stay
            pg.image.load('mario/Next/images/Mario/mario1.png'),

            # 9 Big, move 0
            pg.image.load('mario/Next/images/Mario/mario1_move0.png'),

            # 10 Big, move 1
            pg.image.load('mario/Next/images/Mario/mario1_move1.png'),

            # 11 Big, move 2
            pg.image.load('mario/Next/images/Mario/mario1_move2.png'),

            # 12 Big, jump
            pg.image.load('mario/Next/images/Mario/mario1_jump.png'),

            # 13 Big, end 0
            pg.image.load('mario/Next/images/Mario/mario1_end.png'),

            # 14 Big, end 1
            pg.image.load('mario/Next/images/Mario/mario1_end1.png'),

            # 15 Big, stop
            pg.image.load('mario/Next/images/Mario/mario1_st.png'),

            # =============================================

            # 16 Big_fireball, stay
            pg.image.load('mario/Next/images/Mario/mario2.png'),

            # 17 Big_fireball, move 0
            pg.image.load('mario/Next/images/Mario/mario2_move0.png'),

            # 18 Big_fireball, move 1
            pg.image.load('mario/Next/images/Mario/mario2_move1.png'),

            # 19 Big_fireball, move 2
            pg.image.load('mario/Next/images/Mario/mario2_move2.png'),

            # 20 Big_fireball, jump
            pg.image.load('mario/Next/images/Mario/mario2_jump.png'),

            # 21 Big_fireball, end 0
            pg.image.load('mario/Next/images/Mario/mario2_end.png'),

            # 22 Big_fireball, end 1
            pg.image.load('mario/Next/images/Mario/mario2_end1.png'),

            # 23 Big_fireball, stop
            pg.image.load('mario/Next/images/Mario/mario2_st.png'),
        ]
        ...
        self.sprites.append(pg.image.load('mario/Next/images/Mario/mario_lvlup.png').convert_alpha())

        # Power level changing, left
        self.sprites.append(pg.transform.flip(self.sprites[-1], 180, 0))

        # Death
        self.sprites.append(pg.image.load('mario/Next/images/Mario/mario_death.png').convert_alpha())
    ...
    def player_physics(self, core):
        ...
        if self.rect.colliderect(core.get_map().flag.pillar_rect):
            ...
            # Check if player has collected at least 3/5 crates
            if self.crates >= 3:
                core.get_map().player_win(core)
            else:
                # Game Over if not enough crates collected
                core.get_map().player_death(core)
