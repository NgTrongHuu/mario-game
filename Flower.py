...
class Flower(Entity):
    def __init__(self, x_pos, y_pos):
        ...
        self.image_tick = 0
        self.images = (
            pg.image.load('mario/Next/images/flower0.png').convert_alpha(),
            pg.image.load('mario/Next/images/flower1.png').convert_alpha(),
            pg.image.load('mario/Next/images/flower2.png').convert_alpha(),
            pg.image.load('mario/Next/images/flower3.png').convert_alpha()
        )
