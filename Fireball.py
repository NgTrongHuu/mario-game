...
class Fireball(object):
    def __init__(self, x_pos, y_pos, move_direction: bool):
        ...
        self.image_tick = 0
        self.images = [pg.image.load('mario/Next/images/fireball.png').convert_alpha()]
        ...
        self.images.append(pg.image.load('mario/Next/images/firework0.png').convert_alpha())
        self.images.append(pg.image.load('mario/Next/images/firework1.png').convert_alpha())
        self.images.append(pg.image.load('mario/Next/images/firework2.png').convert_alpha())
