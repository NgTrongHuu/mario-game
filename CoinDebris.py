...
class CoinDebris(object):
    ...
    def __init__(self, x_pos, y_pos):
        ...
        self.image_tick = 0
        self.images = [
            pg.image.load('mario/Next/images/coin_an0.png').convert_alpha(),
            pg.image.load('mario/Next/images/coin_an1.png').convert_alpha(),
            pg.image.load('mario/Next/images/coin_an2.png').convert_alpha(),
            pg.image.load('mario/Next/images/coin_an3.png').convert_alpha()
        ]
